...
This page lists most of the mailing lists relevant to GMOD. The default location for GMOD related lists is [SourceForge](http://sourceforge.net/mail/?group_id=27707), but lists are actually implemented on various servers all over the world.

## Searching Email Lists

GMOD's default mailing list server is Sourceforge. Sourceforge, however, has a notoriously hard to use mail archive search facility. Therefore, we try to archive mailing lists on sites that have friendlier search facilities, such as [Nabble](http://gmod.827538.n3.nabble.com/), [Gmane.org](http://gmane.org), and [Google groups](http://groups.google.com). The tables below link to these archives, whenever they exist.

## Posting to and Membership in Email Lists

Most GMOD lists require you to be a member of the list to post to the list. If you aren't a member, your post will be *deferred* until one of that list's managers has a chance to review your posting. Therefore, *we strongly suggest that you join a list before posting to it.*

## Overview Lists

| Topic | List Link | Comment | Archive(s) |
|-------|-----------|---------|------------|
| Announcements | [gmod-announce](https://lists.sourceforge.net/lists/listinfo/gmod-announce) | Low volume GMOD announcements. Moderated. | [Gmane](http://dir.gmane.org/gmane.science.biology.gmod.announce), [Nabble](http://gmod.827538.n3.nabble.com/Announcements-f815515.html), [Sourceforge](http://sourceforge.net/mailarchive/forum.php?forum_name=gmod-announce) |
| GMOD Developers List | [gmod-devel](https://lists.sourceforge.net/lists/listinfo/gmod-devel) | General GMOD developer list. | [Gmane](http://dir.gmane.org/gmane.science.biology.gmod.devel), [Nabble](http://gmod.827538.n3.nabble.com/Developers-f815538.html), [Sourceforge](http://sourceforge.net/mailarchive/forum.php?forum_name=gmod-devel) |

## Component Lists

Mailing lists about specific [GMOD Components](/wiki/GMOD_Components).
...
These mailing lists are about general topics of interest, rather than about specific software components.

| Name | List Link | Topics | Archive(s) |
|------|-----------|--------|------------|
| CoGePhy | [gmod-cogephy](https://lists.sourceforge.net/lists/listinfo/gmod-cogephy) | Discussion of **co**mparative **ge**nomics, **phy**logeny, and related topics | [Nabble](http://gmod.827538.n3.nabble.com/CoGePhy-f2036734.html), [SourceForge](http://sourceforge.net/mailarchive/forum.php?forum_name=gmod-cogephy) |
| PhenDiver | [gmod-phendiver](https://lists.sourceforge.net/lists/listinfo/gmod-phendiver) | Discussion of **phen**otype, natural **diver**sity, population genetics | [Nabble](http://gmod.827538.n3.nabble.com/PhenDiver-f2036309.html), [SourceForge](http://sourceforge.net/mailarchive/forum.php?forum_name=gmod-phendiver) |

## Inactive Lists

### As of May 2016

These lists have not had postings in the past 12 months (as of May 2016).
...
These lists have not had postings in the past 12 months (as of August 2008).

| List | Comment |
|------|---------|
| [gmod-architecture](https://lists.sourceforge.net/lists/listinfo/gmod-architecture) | GMOD architecture working group list |
| [gmod-chado-seq-ad](https://lists.sourceforge.net/lists/listinfo/gmod-chado-seq-ad) | Last post November 2006 |
| [gmod-citrina](https://lists.sourceforge.net/lists/listinfo/gmod-citrina) | [Citrina](/wiki/Citrina) mailing list. Last post June 2006. No longer supported. |
| [gmod-cmae](https://lists.sourceforge.net/lists/listinfo/gmod-cmae) | [CMAE](/wiki/CMAE) mailing list. Last post July 2007. |
...
There are a couple of mailing lists that, while not affiliated with GMOD, often have content of interest to the GMOD community.

| List Link(s) | Comment | Archive(s) |
|--------------|---------|------------|
| [ISB](http://www.biocurator.org/emaillist.shtml) | List for biological data curators and informatics people who support them | [TAIR](http://mailman.tairgroup.org/pipermail/biocurator/) |
| [Bioperl-l](http://lists.open-bio.org/mailman/listinfo/bioperl-l) | Primary BioPerl mailing list for developers and users | |
| [OBF cross-project](http://lists.open-bio.org/mailman/listinfo/open-bio-l) | Open Bioinformatics Foundation cross-project list | |
