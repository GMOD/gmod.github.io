---
title: "WebApollo v2013-05-16 Installation"
---
...
# <span dir="auto">WebApollo v2013-05-16 Installation</span>
...
- [<span class="tocnumber">2</span>
  ...
  - [<span class="tocnumber">2.6</span> <span class="toctext">User
...
- [<span class="tocnumber">4</span>
  ...
  - [<span class="tocnumber">4.2</span> <span class="toctext">Canned
    comments</span>](#Canned_comments)
  - [<span class="tocnumber">4.3</span> <span class="toctext">Search
    tools</span>](#Search_tools)
    - [<span class="tocnumber">4.3.1</span>
      <span class="toctext">Blat</span>](#Blat)
  - [<span class="tocnumber">4.4</span> <span class="toctext">Data
...
- [<span class="tocnumber">5</span> <span class="toctext">Data
  ...
  - [<span class="tocnumber">5.2</span> <span class="toctext">Static
    ...
    - [<span class="tocnumber">5.2.2</span> <span class="toctext">GFF3
    ...
    - [<span class="tocnumber">5.2.4</span> <span class="toctext">BAM
      data</span>](#BAM_data)
    - [<span class="tocnumber">5.2.5</span> <span class="toctext">BigWig
      data</span>](#BigWig_data)
  - [<span class="tocnumber">5.3</span>
    <span class="toctext">Customizing
    features</span>](#Customizing_features)
  - [<span class="tocnumber">5.4</span> <span class="toctext">Bulk
  ...
  - [<span class="tocnumber">5.5</span> <span class="toctext">Upgrading
...
all of the contents from `$WEB_APOLLO_DIR/WebApollo/json` in our data
directory.
...
CSS styles, so it is possible to omit most of these CSS class arguments
(the exception being renderClassname). For example, to accept default
styles for maker.gff, the above could instead be shortened to:
...
You can still use this script even if the file you're loading is not
storing transcripts and exons. Let's say we want to load `match` and
...
- <span id="t-smwbrowselink"><a href="Special%253ABrowse/WebApollo_v2013-2D05-2D16_Installation"
  rel="smw-browse">Browse properties</a></span>



- <span id="footer-info-lastmod">Last updated at 19:02 on 24 August
  2013.</span>
