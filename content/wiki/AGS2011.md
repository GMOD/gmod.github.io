...
|----|----|----|
| Mercurial | `sudo apt-get install mercurial` | Revision control system used by [Galaxy](/wiki/Galaxy.1) |
| Microsoft TrueType core fonts | `sudo apt-get install ttf-mscorefonts-installer` | Used by [Galaxy](/wiki/Galaxy.1). |
| python-dev | `sudo apt-get install python-dev ` | Used in [Galaxy](/wiki/Galaxy.1). |
| python-setuptools | `sudo apt-get install python-setuptools` | Used in [Galaxy](/wiki/Galaxy.1). |
| python-pip | `sudo apt-get install python-pip` | Used in [Galaxy](/wiki/Galaxy.1). |
...
| Graphics libraries | `sudo apt-get install libgd2-xpm-dev libgd-gd2-perl libgd-tools libgd-svg-perl` | Used by [GBrowse](/wiki/GBrowse.1) |
| System utilities and web server | `sudo apt-get install autoconf apache2` | Used by [GBrowse](/wiki/GBrowse.1) and <a href="/wiki/Chado" class="mw-redirect" title="Chado">Chado</a> |
| Database server | `sudo apt-get install postgresql postgresql-client` | Used by <a href="/wiki/Chado" class="mw-redirect" title="Chado">Chado</a> and [GBrowse](/wiki/GBrowse.1) |
| Variety of perl modules | `sudo apt-get install libcgi-session-perl libdbd-pg-perl libdigest-md5-file-perl libclass-base-perl libmodule-build-perl libstatistics-descriptive-perl libtemplate-perl libxml-simple-perl liblog-log4perl-perl libparse-recdescent-perl libsql-translator-perl perl-doc` | Used by <a href="/wiki/Chado" class="mw-redirect" title="Chado">Chado</a> and [GBrowse](/wiki/GBrowse.1) |
| Perl modules | `sudo apt-get install libjson-xs-perl libdevel-size-perl` | Used by [JBrowse](/wiki/JBrowse.1) |
| Perl graphics library | `cpan> install GD` | Used by [JBrowse](/wiki/JBrowse.1) and [GBrowse](/wiki/GBrowse.1) |
| BioPerl libraries | `cpan> install Bio::Perl Bio::Graphics JSON` | Used by [JBrowse](/wiki/JBrowse.1), [GBrowse](/wiki/GBrowse.1) and <a href="/wiki/Chado" class="mw-redirect" title="Chado">Chado</a> |
| GBrowse Chado adaptor | `cpan> install Bio::DB::Das::Chado` | Used by [JBrowse](/wiki/JBrowse.1), [GBrowse](/wiki/GBrowse.1) and <a href="/wiki/Chado" class="mw-redirect" title="Chado">Chado</a> |
...
| Even more perl libraries | `cpan> install Heap::Simple Heap::Simple::Perl Heap::Simple::XS PerlIO::gzip` | Used by [JBrowse](/wiki/JBrowse.1) |
