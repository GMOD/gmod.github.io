...
closure](/wiki/Chado_CV_Module#Transitive_Closure)_ of all
terms in an ontology. There is a great explanation of transitive closure
on the [Chado CV Module
page](/wiki/Chado_CV_Module#Transitive_Closure). Also see
the description of these 3 tables:

- [cvterm](/wiki/Chado_CV_Module#Table:_cvterm)
- [cvterm_relationship](/wiki/Chado_CV_Module#Table:_cvterm_relationship)
- [cvtermpath](/wiki/Chado_CV_Module#Table:_cvtermpath)
...
database](/wiki/Load_GFF_Into_Chado#Add_an_Entry_for_Your_Organism):
...
### Preparing [GFF](/wiki/GFF) data for loading
...
#### Working with Large [GFF](/wiki/GFF) files
...
Argh! Now the loader is pointing out that this [GFF](/wiki/GFF) file has
...
- Embrace a minimal definition of what an expression pattern is. In
  Chado, all that is required is a _name_, e.g., _SLC21A in GMOD Course
  Participant kidney after 4 days at NESCent_, or just "GMOD0002347".
