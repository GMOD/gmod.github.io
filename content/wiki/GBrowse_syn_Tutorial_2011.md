...
installation](/wiki/GBrowse_2.0_HOWTO).
...
- Then check out a fresh copy of the current GBrowse 2 source code via
  <a href="/wiki/SVN" class="mw-redirect" title="SVN">subversion (svn)</a>.
...
- The alignment data are in a <span class="pops">[constrained CLUSTALW
  format](/wiki/GBrowse_syn_Database#Clustal_alignment_format)</span>
