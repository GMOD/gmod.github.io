...
Module](/wiki/Chado_Group_Module). New and modified
tables relative to Chado version 1.23 are indicated in green.

### Option 1: [Group Module](/wiki/Chado_Group_Module) is an intrinsic part of the phenotype_cvterm table
...
### Option 2: [Group Module](/wiki/Chado_Group_Module) is decoupled from the phenotype_cvterm table
