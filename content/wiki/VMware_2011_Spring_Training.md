...
<td>Java run time and tools; need for <a href="/wiki/Apollo"
...
<td>High-res image generation in <a href="/wiki/GBrowse"
...
<td>MySQL database; used as a backend to <a href="/wiki/GBrowse"
...
<td>C++ compiler from GNU. Required for <a href="/wiki/MAKER"
...
as <a href="/wiki/GBrowse" title="GBrowse">GBrowse</a>.</td>
</tr>
<tr class="odd">
...
<td>Used in <a href="/wiki/Galaxy" title="Galaxy">Galaxy</a> session.</td>
</tr>
<tr class="odd">
