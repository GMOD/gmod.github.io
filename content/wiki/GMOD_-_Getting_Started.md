...
- [Overview](/wiki/Overview) is a broad introduction, that does not
  assume any prior knowledge of computing. This is an excellent place to
  start.
- [GMOD Components](/wiki/GMOD_Components) is a complete
...
- [Getting Started with
  Chado](/wiki/Chado_-_Getting_Started) discusses
...
mailing lists](/wiki/GMOD_Mailing_Lists), these tend to
focus on more technical aspects. Another good resource is the [GMOD Help
Desk](/wiki/GMOD_Help_Desk) - feel free to write them with
questions on any type, they are tasked with providing support to
newcomers and experts alike.

See [Support](/wiki/Support) for more information.
