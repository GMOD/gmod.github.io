...
annotations.
 ...
 - [Manual
 Genome Annotation](#Manual_Genome_Annotation)
 - [Computational Genome
 Annotation](#Computational_Genome_Annotation)
- [Publication
 Annotation](#Publication_Annotation)
- [Community
...
- [Apollo](/wiki/Apollo) is the manual genome annotation tool of
...
First line of the [MAKER](/wiki/MAKER) paper.

- [MAKER](/wiki/MAKER) is a pipeline for annotating eukayotic
 genomic data.
- [DIYA](/wiki/DIYA) is a pipeline for annotation prokaryotic genomic
 data.
- <a href="/wiki/Ergatis" class="mw-redirect" title="Ergatis">Ergatis</a> is a
 web-based utility for creating and running reusable computational
 analysis pipelines.
- [Galaxy](/wiki/Galaxy) allows users to search remote resources,
 combine data from independent queries, and visualize/save the results.
- [Genome grid](/wiki/Genome_grid) project is a package of
 genome data analysis with methods, protocols, and documentation.

## Publication Annotation

- [Textpresso](/wiki/Textpresso) is a text mining package for
...
- [Apollo](/wiki/Apollo) is used in several community annotation
 efforts to maintain and curate genomic data.
- [TableEdit](/wiki/TableEdit) is a popular
 ...
 <a href="/wiki/Chado" class="mw-redirect" title="Chado">Chado</a> using
 TableEdit.
