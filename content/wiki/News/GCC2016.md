...
width="150" height="126" alt="GMOD2016ColorsBigLetters 300px.png" />](../Jun_2016_GMOD_Meeting)
...
Meeting](../Jun_2016_GMOD_Meeting), also in
Bloomington.** [Galaxy](../Galaxy.1) is a GMOD Component which
interacts with many other [GMOD
Components](../GMOD_Components), including:

- [Tripal](../Tripal.1): A web front end for
  <a href="../Chado" class="mw-redirect" title="Chado">Chado</a>
  databases. Galaxy is working with the Tripal project to make Galaxy be
  Tripal's analysis engine.
- [JBrowse](../JBrowse.1): A client-side genome browser and
  successor to the venerable [GBrowse](../GBrowse.1). <a
...
- [MAKER](../MAKER.1): A genome annotation pipeline that
...
- [InterMine](../InterMine) and
  [BioMart](../BioMart): These are both popular data sources
...
*Posted to the [GMOD News](../GMOD_News) on 2016/04/04*
