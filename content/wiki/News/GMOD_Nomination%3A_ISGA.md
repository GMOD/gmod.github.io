---
title: "News/GMOD Nomination: ISGA"
---
...
height="143" alt="ISGA" />](../ISGA)

I would like to nominate [ISGA](../ISGA) for [GMOD
Membership](../GMOD_Membership). ISGA is a
...
[GBrowse](../GBrowse.1) and BLAST for visualizing and
...
Hemmerich](../User%253AChemmeri), Aaron Buechlein, Ram
...
requirements](../GMOD_Membership#Requirements). The
...
<a href="../Ergatis" class="mw-redirect" title="Ergatis">Ergatis</a>
users. Please see the [ISGA](../ISGA) page for more information.
...
*Posted to the [GMOD News](../GMOD_News) on 2010/07/29*
