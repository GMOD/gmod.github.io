...
width="220" height="137" alt="CMap3D" />](../CMap3D)
...
genetic maps that runs on top of a [CMap](../CMap.1) database.
[CMap](../CMap.1), a [GMOD
component](../GMOD_Components), is a common tool for
...
operability with current [CMap](../CMap.1) data repositories.

[CMap3D](../CMap3D) can be applied to any species where genetic
map information is available and enables rapid, direct comparison
between multiple aligned maps. For more on [CMap3D](../CMap3D)
see the
<a href="http://acpfg.imb.uq.edu.au/cmap3d.php" class="external text"
...
CMap3D](https://raw.githubusercontent.com/GMOD/gmod.github.io/main/mediawiki/images/3/31/PAG2010CMap3D.pdf) (and other
tools), and the <a
