...
There is a new release of [WebApollo](../../../WebApollo.1)
available from the
...
Installation](../../../WebApollo_Installation)
page, and the <a
...
store](../../../WebApollo_Installation#Upgrading_existing_annotation_data_stores).
...
*Posted to the [GMOD News](../../../GMOD_News) on
2013/11/22*
