...
| Sept 28-30 | Genome Annotation | Students will learn how to produce publication quality genome annotations ready for community access, first by using [MAKER](../MAKER.1) to create initial automated annotations, and then [Apollo](../Apollo.1) to manually refine them. |
