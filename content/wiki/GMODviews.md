...
combinations of Views data, to create complex *dashboards* for
displaying genomics data in custom configurations without having to
write PHP code.

## <span id="GMOD_Status" class="mw-headline">GMOD Status</span>
...
- <span id="footer-info-lastmod">Last updated at 05:38 on 5 January
  2011.</span>
<!-- - <span id="footer-info-viewcount">11,201 page views.</span> -->
